...
## Table of contents
1. [Merge two objects](#merge-two-objects)
2. [Merge three object](#merge-three-object)
3. [Grouping array of objects with name key](#grouping-array-of-objects-with-name-key)
4. [Grouping array of objects by skill key](#grouping-array-of-objects-by-skill-key)
5. [Comparing two objects](#comparing-two-objects)
6. [Convert Roman numeral](#convert-roman-numeral)
7. [Filter for JSON Array](#filter-with-json-array) 
8. [Self-invoking function](#self-invoking-functions)
9. [JavaScript Modules](#javascript-modules)
10. [indexOf on an array of objects](#indexof-on-an-array-of-objects)
	 - Use Array.map().
	 - use Array.findIndex().
...
```
  ...
  /*
  function categoryTitleHover(){
    var categoryTitle = $('#category_title');
    var socialmedia = $('#socialmedia');

    function hover_in(){
        socialmedia.show("fast");
    }
    function hover_out(){
        socialmedia.hide('slow');
    }
    categoryTitle.hover(hover_in, hover_out);
  }
  */
```

## Self Invoking Functions
- A Self-invoking function runs immediately.
```
isShoppingCart;
```
- Regular function:
...
if(isShoppingCart){
  console.log('A shopping cart page.');
}

```
## JavaScript Modules
- Point 1: function scope - The valuables that is defined into a Function can't acceess from outside. To use this rule, we can make a private namespace - which is called "Closure".
- Point 2: The class syntax is *not* introducing a JavaScript but using Module Pattern, we can create a CLASS such like Java or C# has.

#### Example: Object interface
- categoryTitle.js

```
var categoryTitle = (function(){
  // Private	
  var titleArray = []
  // Private
  function getLogoTitle(id){}

  // Global
  return{
  init: function(){
    var id = $('#category_box').data('category-id');
    getLogoTitle(id)
  }
}();
```
...
## List of the Methods in this document.
...
## References:
- [Mozilla Developer Network - hasOwnProperty](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object/hasOwnProperty)
- [Mozilla Developer Network - filter](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter)
...
- [JavaScript Modules](https://medium.freecodecamp.com/javascript-modules-a-beginner-s-guide-783f7d7a5fcc#.986qnghox)
- [About Module Pattern](http://qiita.com/Im0_3/items/3d46f900aa4d4c5c3cde)
- [About Module Pattern](http://qiita.com/chuck0523/items/1868a4c04ab4d8cdfb23)
